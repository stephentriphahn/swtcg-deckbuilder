(ns stevetrip.swtcg.deck-builder.validation.service
  (:require
   [clara.rules :as rules]
   [stevetrip.swtcg.deck-builder.validation.rules :as vrules]))
...
(defn validate-deck
  ...
  (let [deck-fact (vrules/map->Deck deck)
        ...
        session (-> (rules/mk-session 'stevetrip.swtcg.deck-builder.validation.rules)
