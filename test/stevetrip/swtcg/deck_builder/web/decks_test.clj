(ns stevetrip.swtcg.deck-builder.web.decks-test
...
(defn with-app [f]
  ;; relative name: stevetrip.swtcg.deck-builder.db.db/parsed-cs->jdbc-config reads sqlite paths from the URI host
